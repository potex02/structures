...
//
// Equals does not take into account the effective type of st. This means that if st is an [ArrayQueue],
// but the elements of q and the elements of st are equals, this method returns anyway true.
func (q *LinkedQueue[T]) Equals(st structures.Structure[T]) bool {
