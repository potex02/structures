...
func TestNewMultiHashTableFromSlice(t *testing.T) {
	...
	var table *MultiHashTable[wrapper.String, float32] = NewMultiHashTableFromSlice[wrapper.String, float32](
...
func TestContainsMultiHashTable(t *testing.T) {
	...
	var table MultiTable[wrapper.String, float32] = NewMultiHashTableFromSlice[wrapper.String, float32](
		[]wrapper.String{"Hello", "Ciao", "a", "Ciao"},
		[]float32{1.2, 5.6, -1, 0},
	)
...
func TestEqualMultiHashTable(t *testing.T) {
	...
	var table BaseTable[wrapper.String, float32] = NewMultiHashTableFromSlice[wrapper.String, float32](
		[]wrapper.String{"Hello", "Ciao", "a", "Ciao"},
		[]float32{1.2, 5.6, -1, 0},
	)
	var tableTest *MultiHashTable[wrapper.Int, test] = NewMultiHashTableFromSlice[wrapper.Int, test](
		[]wrapper.Int{1, -2, -2, 3},
