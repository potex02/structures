...
func TestContainsKeyTreeTable(t *testing.T) {
	...
	var table Table[wrapper.String, float32] = NewTreeTableFromSlice([]wrapper.String{"Hello", "Ciao"}, []float32{1.2, 5.6})
...
func TestGetTreeTable(t *testing.T) {
	...
	var table *TreeTable[wrapper.Byte, int] = NewTreeTableFromSlice([]wrapper.Byte{'a', 'b'}, []int{1, -1})
...
func TestCompareTreeTable(t *testing.T) {
	...
	if table.Compare(NewTreeTableFromSlice([]wrapper.String{"Hello", "Ciao"}, []float32{1.2, 5.6})) != 0 {
