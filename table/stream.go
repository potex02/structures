...
// Stream provides aggregate operations for a [Table].
...
// NewStream returns a new [Stream] associated at the table parameter.
//
...
//
// This methods panics if constructor have wrong parameters or not returns a Table[K, T].
