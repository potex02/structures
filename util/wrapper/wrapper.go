...
func NewWrapperBuilder[T any](equal func(w Wrapper[T], o any) bool, compare func(w Wrapper[T], o any) int, hash func(w Wrapper[T]) string, copy func(w Wrapper[T]) T) WrapperBuilder[T] {
